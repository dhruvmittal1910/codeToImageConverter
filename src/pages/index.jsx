...
export default function Home() {
  ...
  const handlePrint = () => {
    ...
    printWindow.document.close(); // Ensure content is fully loaded before printing
    printWindow.print();
  };
  ...
  const closeModal = (e) => {
    if (e.target.id === "modal-overlay") {
      setIsModalOpen(false); // Close the modal if click is outside the modal content
    }
  };
    ...
    <div className="flex justify-center items-center mx-auto min-h-screen bg-black">
      <div>
        <div className="text-center text-white text-4xl font-bold mb-8">
          <Typewriter
            options={{
              strings: ["Code to Image Converter"],
              autoStart: true,
              loop: true, // Ensures no repeated typing
              delay: 50,
          ...
          >
            <div className="modal-content">
              ...
              <div className="modal-buttons">
                <button onClick={handlePrint} className="bg-blue-400 p-2 text-white rounded-lg">
                  Print QR Code
                </button>
                <button onClick={handleShare} className="bg-green-400 p-2 text-white rounded-lg">
                  Share QR Code
                </button>
              </div>
              ...
              <button
                ...
                className="bg-gray-500 p-2 text-white rounded-lg mt-2"
              >
                Close
              </button>
            </div>
